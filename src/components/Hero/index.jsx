    ...
    <section id="home" className="relative min-h-screen overflow-x-hidden flex flex-col md:flex-row gap-[8%]">
      <div className="relative w-full sm:w-auto">
        ...
        <div className="absolute inset-0 flex flex-col justify-end mb-10 items-center md:hidden bg-black/40">
          <h2 className="text-[18px] font-noto-serif uppercase mb-4 text-white">Personal & corporate branding</h2>
      ...
      <div className="hidden md:flex flex-col justify-center items-center pr-10 2xl:pr-0">
        <h2 className="text-[18px] lg:text-[20px] font-noto-serif uppercase mb-4">Personal & corporate branding</h2>
        <h1 className="text-[30px] lg:text-[50px] xl:text-[60px] leading-[110%] font-instrument-serif text-center max-w-[500px] xl:max-w-[550px]">Build LinkedIn clarity, confidence & community in 60 days</h1>
      ...
      <div className="absolute bottom-20 right-2 hidden md:flex flex-col items-center gap-7">
