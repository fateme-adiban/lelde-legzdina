...
const Index = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row px-10 mt-30 md:mt-40 justify-between">
        <div className="flex flex-col gap-10 md:mt-15 lg:mt-0 lg:justify-center">
          <h2 className="text-[40px] xl:text-[60px] font-instrument-serif max-w-[500px] leading-[100%]">
      ...
      <div className="flex flex-col md:flex-row md:mt-20 2xl:mt-0 px-10 justify-between md:gap-20 2xl:gap-0">
        ...
        <div className="flex flex-col lg:justify-center md:mt-15 lg:mt-0">
          <h3 className="text-[30px] xl:text-[52px] font-instrument-serif leading-[120%] lg:leading-[150%] max-w-[90%] md:max-w-[830px] mt-10 md:mt-0">
